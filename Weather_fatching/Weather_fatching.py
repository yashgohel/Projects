...
url = f"https://api.open-meteo.com/v1/forecast?latitude=23.014&longitude=72.59&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Ahmedabad Weather - Past Week')
plt.legend()
...
df.to_csv('data/ahmedabad_weather.csv', index=False)
